 ...
 *
 * - Fixes "Invalid hook call" by ensuring hooks are called inside the component body.
  ...
  useEffect(() => {
    if (active && iframeRef.current) {
      try {
        ...
        console.warn('Autoplay postMessage failed; relying on embed attributes.', err);
      }
    }
  }, [active]);
  /**
